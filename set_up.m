...
forbid=[30,10,10,10,10;10,10,10,5,30;25,25,5,10,10;5,5,25,10,15;15,35,20,10,15;1,40,5,10,10;10,35,5,5,10];
...
my_addmesh(scene,forbid(7,1),forbid(7,2),forbid(7,3),forbid(7,4),forbid(7,5))
show3D(scene);
